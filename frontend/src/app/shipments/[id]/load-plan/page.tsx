        ...
        {isSaved && (
          <Alert className="border-green-200 bg-green-50">
            ...
            <AlertDescription className="text-green-800">
              Load plan has been saved and attached to the shipment. The loading
              team can now use this plan for cargo placement.
            </AlertDescription>
          </Alert>
        )}
        ...
        {generateLoadPlan.isError && (
          <Alert className="border-red-200 bg-red-50">
            ...
            <AlertDescription className="text-red-800">
              Failed to generate load plan. Please try again or contact support
              ...
              <div className="max-w-md mx-auto space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2">
                    Generate 3D Load Plan
                  </h3>
                  <p className="text-gray-600 text-sm">
                    Create an optimized 3D visualization showing how to
                    efficiently load all consignment items into the selected
                    vehicle.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Card>
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-sm font-medium">
                      {loadPlan.efficiency_stats.volume_utilization.toFixed(1)}%
                    </p>
