...
import {
  epgTemplateService,
  type EPGData,
  type EPGGenerationRequest,
} from "@/services/epgTemplateService";
import EPGViewer from "@/shared/components/epg/EPGViewer";
...
export default function SDSViewer({ sdsData, className = "" }: SDSViewerProps) {
  ...
  const handleGenerateEPG = async () => {
    ...
    try {
      ...
      if (
        !transportInfo?.unNumber ||
        !transportInfo?.transportHazardClass ||
        !transportInfo?.properShippingName
      ) {
        setEPGError(
          "Missing transport information required for EPG generation. UN number, hazard class, and proper shipping name are required.",
        );
        return;
      }
      ...
      setEPGError(
        error instanceof Error ? error.message : "Failed to generate EPG",
      );
    } finally {
  ...
  const getHazardClassColor = (hazardClass: string) => {
    if (hazardClass.includes("flammable") || hazardClass.includes("3"))
      return "bg-red-600";
    if (hazardClass.includes("oxidiz") || hazardClass.includes("5.1"))
      return "bg-yellow-600";
    if (hazardClass.includes("corrosiv") || hazardClass.includes("8"))
      return "bg-gray-600";
    if (hazardClass.includes("toxic") || hazardClass.includes("6.1"))
    ...
    >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                {sdsData.chemicalName}
              </h1>
              <div className="flex items-center gap-4 mt-1">
                {sdsData.casNumber && (
                  <span className="text-sm text-gray-600">
                    CAS: {sdsData.casNumber}
                  </span>
                )}
                {sdsData.productIdentifier && (
                  <span className="text-sm text-gray-600">
                    Product ID: {sdsData.productIdentifier}
                  </span>
                )}
              </div>
            </div>
          ...
          <div className="flex items-center gap-3">
            <div className="text-right">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Confidence:{" "}
                {Math.round(sdsData.processingMetadata.confidence * 100)}%
              </p>
            </div>
            <Button
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="identification" className="p-6 space-y-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-900 font-medium mt-1">
                        {sdsData.extractedData.supplierDetails?.name ||
                          sdsData.manufacturer ||
                          "Not Available"}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-gray-900 font-medium flex items-center gap-2 mt-1">
                        ...
                        {sdsData.extractedData.supplierDetails?.emergency ||
                          "1800 033 111"}
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-900 font-medium flex items-start gap-2 mt-1">
                        ...
                        {sdsData.extractedData.supplierDetails?.address ||
                          "1 Nicholson St, Melbourne VIC, Australia, 3000"}
                      </p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-500 uppercase tracking-wide">
                      ...
                      <p className="text-gray-900 font-medium mt-1">
                        {sdsData.extractedData.supplierDetails?.phone ||
                          "(03) 9665 7111, 1300 646 662"}
                      </p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-500 uppercase tracking-wide">
          ...
          <section>
            ...
            <div className="bg-white rounded-lg overflow-hidden border border-gray-200 shadow-sm">
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="text-left p-4 text-sm font-semibold text-gray-700 border-r border-gray-200">
                      Ingredient
                    </th>
                    <th className="text-center p-4 text-sm font-semibold text-gray-700 border-r border-gray-200">
                      CAS Number
                    </th>
                    <th className="text-center p-4 text-sm font-semibold text-gray-700 border-r border-gray-200">
                      EC Number
                ...
                <tbody>
                  {sdsData.extractedData.ingredients?.map(
                    (ingredient, index) => (
                      <tr
                        key={index}
                      ...
                      >
                        <td className="p-4 border-r border-gray-200">
                          <div className="flex items-center gap-2">
                            <div
                              className={`w-3 h-3 rounded-full ${ingredient.hazardous ? "bg-red-500" : "bg-green-500"}`}
                            ></div>
                        ...
                        <td className="p-4 text-center">
                          <Badge
                            variant={
                              ingredient.hazardous ? "destructive" : "secondary"
                            }
                            className="font-mono"
                          >
                    ...
                    <tr className="border-t border-gray-200 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="p-4 text-center">
                        <Badge
                          variant="outline"
                          className="font-mono bg-[#153F9F] text-white border-[#153F9F]"
                        >
                          &gt;98%
                        </Badge>
                      </td>
            ...
            <div className="flex items-center justify-between mt-3">
              <p className="text-sm text-gray-600 flex items-center gap-2">
                ...
                {sdsData.extractedData.ingredients?.length || 1} Active
                Ingredients
              </p>
                ...
                <tbody>
                  ...
                  <tr className="border-t border-gray-200 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="p-4 border-r border-gray-200">
                      <Badge
                        variant="outline"
                        className="border-blue-300 text-[#153F9F] bg-blue-50"
                      >
                        EU Regulation
                      </Badge>
                    </td>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                  ...
                  <p className="text-gray-600 text-sm">
                    {sdsData.extractedData.recommendedUse ||
          ...
          {/* Synonyms */}
          <section>
            <h2 className="text-xl font-semibold text-[#153F9F] mb-4">
              SYNONYMS
            </h2>
              ...
              <div className="bg-white rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                ...
                <div className="p-4 space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-gray-900 font-medium">
                      {sdsData.extractedData.physicalProperties?.appearance ||
                        "White to off-white granular solid"}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Odor</span>
                    <span className="text-gray-900 font-medium">
                      {sdsData.extractedData.physicalProperties?.odor ||
                        "Slight odour"}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <Badge
                      variant="outline"
                      className="border-[#153F9F] text-[#153F9F] bg-blue-50 font-mono"
                    >
                      {sdsData.extractedData.physicalProperties?.pH ||
                        "4.5 to 5.2"}
                    </Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-gray-900 font-medium font-mono">
                      {sdsData.extractedData.physicalProperties?.density ||
                        "Not available"}
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                ...
                <div className="p-4 space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge
                      variant="outline"
                      className="border-red-300 text-red-600 bg-red-50 font-mono"
                    >
                      {sdsData.extractedData.physicalProperties?.meltingPoint ||
                        "160°C to 169°C"}
                    </Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <Badge
                      ...
                      className="border-red-300 text-red-600 bg-red-50 font-mono"
                    >
                      {sdsData.extractedData.physicalProperties?.boilingPoint ||
                        "Decomposes"}
                    </Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <Badge
                      variant="outline"
                      className="border-orange-300 text-orange-600 bg-orange-50 font-mono"
                    >
                      {sdsData.extractedData.physicalProperties?.flashPoint ||
                        "Not relevant"}
                    </Badge>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                ...
                <div className="p-4 space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge
                      variant="outline"
                      className="border-blue-300 text-blue-600 bg-blue-50 font-mono"
                    >
                      {sdsData.extractedData.physicalProperties?.solubility ||
                        "Soluble"}
                    </Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-gray-900 font-medium font-mono">
                      {sdsData.extractedData.physicalProperties
                ...
                <tbody>
                  <tr className="border-t border-gray-200 hover:bg-gray-50">
                    ...
                    <td className="p-3 text-gray-600">
                      Inorganic arsenic plus methylated metabolites in urine
                    </td>
          ...
          <section>
            ...
            <div className="bg-red-50 border border-red-200 p-4 rounded-lg">
              <p className="text-red-800 font-medium">
                {sdsData.extractedData.hazardClassification?.join(", ") ||
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    ...
                    <span className="text-gray-900 ml-2 font-medium">
                      {sdsData.extractedData.transportInfo?.unNumber || "1942"}
                    </span>
                  </div>
                  <div>
                    <span className="text-gray-600">Shipping Name:</span>
                    <p className="text-gray-900 font-medium">
                      {sdsData.extractedData.transportInfo
                        ?.properShippingName ||
                  ...
                  <div>
                    ...
                    <span className="text-gray-900 ml-2 font-medium">
                      {sdsData.extractedData.transportInfo?.packingGroup ||
                        "III"}
                    </span>
                  </div>
                  <div>
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    ...
                    <span className="text-gray-900 ml-2 capitalize font-medium">
                      {sdsData.processingMetadata.extractionMethod}
                    </span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <span className="text-gray-900 ml-2 font-medium">
                      {sdsData.processingMetadata.processingTime}ms
                    </span>
                  </div>
                  <div>
                    <span className="text-gray-600">Pages:</span>
                    <span className="text-gray-900 ml-2 font-medium">
                      {sdsData.processingMetadata.pageCount}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Generated from {sdsData.chemicalName} SDS
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2">
