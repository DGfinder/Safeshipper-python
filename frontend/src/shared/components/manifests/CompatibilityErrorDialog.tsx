    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            The selected dangerous goods cannot be transported together due to
            safety regulations. Please review the conflicts below and modify
            your selection.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
                ...
                <Alert key={index} className="border-l-4 border-l-red-500">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      {conflict.items_involved &&
                        conflict.items_involved.length > 0 && (
                          <div>
          ...
          {safety_analysis && (
            <div>
              ...
              <div className="space-y-3">
                ...
                {safety_analysis.mitigation_options &&
                  safety_analysis.mitigation_options.length > 0 && (
                    <div>
                      <span className="text-sm font-medium text-gray-700 mb-2 block">
                        Possible Mitigation Options:
                      </span>
                      <ul className="list-disc list-inside space-y-1 text-sm text-gray-600">
                        {safety_analysis.mitigation_options.map(
                          (option, index) => (
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p className="text-sm text-gray-600 mb-3">
              These compatibility checks are based on international dangerous
              goods regulations including IATA DGR, IMDG Code, and ADR/ADN
              requirements.
            </p>
            <Button
              variant="outline"
              size="sm"
              onClick={() =>
                window.open("https://www.iata.org/en/cargo/dgr/", "_blank")
              }
            >
        ...
        <DialogFooter className="flex items-center justify-between">
          <div className="text-sm text-gray-600">
            ⚠️ Transportation of incompatible dangerous goods may violate safety
            regulations
          </div>
