...
export default function AIInsightsDashboard({
  ...
  const [fleetAnalytics, setFleetAnalytics] =
    useState<ContainerFleetAnalytics | null>(null);
  ...
  const [safetyAnalytics, setSafetyAnalytics] =
    useState<SafetyAnalytics | null>(null);
  ...
  useEffect(() => {
    ...
    const initializeMonitoring = async () => {
      ...
      await computerVisionSafetyService.initializeRealtimeMonitoring(
        "facility-001",
        ["cam-001", "cam-002"],
      );
      ...
      const unsubscribeRisk =
        predictiveRiskAnalyticsService.subscribeToRiskUpdates((riskFactor) => {
      ...
      const unsubscribeAlerts =
        iotSmartContainerService.subscribeToContainerAlerts((alert) => {
      ...
      const unsubscribeSafety =
        computerVisionSafetyService.subscribeToSafetyAlerts((alert) => {
          setSafetyAlerts((prev) => {
            const filtered = prev.filter(
              (a) => (a as any).alertId !== (alert as any).alertId,
            );
      ...
      const unsubscribePPE =
        computerVisionSafetyService.subscribeToPPEViolations((violation) => {
          setPPEViolations((prev) => {
            const filtered = prev.filter(
              (v) => v.personId !== violation.personId,
            );
      ...
      const unsubscribeRegulation =
        regulatoryComplianceService.subscribeToRegulationUpdates((update) => {
    ...
    const metricsInterval = setInterval(() => {
      setLiveMetrics((prev) => ({
        ...
        activeContainers:
          prev.activeContainers + Math.floor(Math.random() * 2) - 1,
        riskAlertsCount: Math.max(
          0,
          prev.riskAlertsCount + Math.floor(Math.random() * 3) - 1,
        ),
        complianceScore: Math.min(
          100,
          prev.complianceScore + (Math.random() - 0.5) * 0.1,
        ),
  ...
  const loadFleetAnalytics = async () => {
    try {
      const analytics =
        await iotSmartContainerService.getFleetAnalytics("month");
      if (analytics) {
  ...
  const loadSafetyAnalytics = async () => {
    try {
      const analytics = await computerVisionSafetyService.getSafetyAnalytics(
        "facility-001",
        "day",
      );
      if (analytics) {
  ...
  const loadComplianceMetrics = async () => {
    try {
      const metrics =
        await regulatoryComplianceService.getComplianceMetrics("month");
      if (metrics) {
    ...
    const mockAlerts: ContainerAlert[] = [
      {
        ...
        description:
          "Container temperature has exceeded maximum threshold for refrigerated cargo",
    ...
    const mockUpdates: RegulationUpdate[] = [
      {
        ...
        description:
          "New packaging and labeling requirements for lithium batteries effective January 2025",
        ...
        changeDetails: {
          newRequirement:
            "Enhanced fire suppression systems required for lithium battery shipments",
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Real-time intelligence for dangerous goods transport
            </p>
          </div>
        </div>
        <div className="flex items-center gap-3">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {liveMetrics.totalShipments.toLocaleString()}
                </p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold">
                  AI-Powered Optimization Savings
                </h3>
                <p className="text-blue-100">
                  Predictive analytics and smart routing this month
                </p>
              </div>
            </div>
                  ...
                  activeRiskFactors.map((factor) => (
                    <div key={factor.id} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-gray-500">
                          {factor.confidence * 100}% confidence
                        </span>
                      </div>
                      ...
                      <div className="text-xs text-gray-500">
                        ...
                        {new Date(factor.detectedAt).toLocaleTimeString()}
                      </div>
                    </div>
                  ))
                ) : (
              ...
              <CardContent className="space-y-4">
                <div className="border rounded-lg p-4 bg-green-50">
                  ...
                  <p className="text-sm text-green-700 mb-2">
                    Alternative route via M7 reduces risk by 25% and saves 2
                    hours
                  </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 border rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600">
                      Heavy rain expected in Melbourne-Sydney corridor
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-4 p-3 border rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600">
                      Peak traffic congestion during morning rush
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-4 p-3 border rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600">
                      Vehicle CONT-789 requires brake maintenance
                    </div>
                  </div>
                  ...
                  containerAlerts.slice(0, 5).map((alert) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-xs">
                        <span>
                          {alert.sensorData.parameter}:{" "}
                          {alert.sensorData.currentValue}
                          {alert.sensorData.parameter === "temperature"
                            ? "°C"
                            : ""}
                        </span>
                  ...
                  safetyAlerts.map((alert) => (
                    ...
                    >
                      ...
                      <h4 className="font-medium mb-1">
                        Proximity Alert: {alert.targetId}
                      </h4>
                      <p className="text-sm text-gray-600 mb-2">
                        Distance: {alert.distance}m (Min:{" "}
                        {alert.minimumSafeDistance}m)
                      </p>
                      <div className="flex items-center justify-between text-xs">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="text-center p-3 bg-green-50 rounded-lg">
                      <div className="text-2xl font-bold text-green-600">
                        {safetyAnalytics.metrics.ppeComplianceRate.toFixed(1)}%
                      </div>
                      <p className="text-sm text-green-700">PPE Compliance</p>
                    </div>
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      <div className="text-2xl font-bold text-blue-600">
                        {safetyAnalytics.overallSafetyScore}
                      </div>
                  ...
                  ppeViolations.map((violation, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-gray-500">
                          {violation.confidence * 100}% confidence
                        </span>
                      </div>
                      <h4 className="font-medium mb-1">
                        Worker {violation.personId}
                      </h4>
                ...
                {complianceMetrics && (
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="text-center p-3 border rounded-lg">
                        <div className="text-xl font-bold text-blue-600">
                          {complianceMetrics.automationEfficiency.toFixed(1)}%
                        </div>
                        <p className="text-xs text-gray-600">Automation Rate</p>
                      </div>
                      <div className="text-center p-3 border rounded-lg">
                        <div className="text-xl font-bold text-purple-600">
                          {complianceMetrics.metrics.timeSavings}
                        </div>
                    ...
                    <div className="border rounded-lg p-4 bg-blue-50">
                      ...
                      <div className="text-2xl font-bold text-blue-600">
                        $
                        {complianceMetrics.metrics.costSavings.toLocaleString()}
                      </div>
                      <p className="text-sm text-blue-700">
                        Saved through automation this month
                      </p>
                    </div>
                  </>
                )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card>
              ...
              <CardContent className="text-center">
                <div className="text-4xl font-bold text-[#153F9F] mb-2">
                  87.3%
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="border rounded-lg p-4 bg-blue-50">
                  ...
                  <p className="text-sm text-blue-700 mb-2">
                    AI analysis suggests alternative routing could reduce
                    dangerous goods transport risks by 30% while maintaining
                ...
                <div className="border rounded-lg p-4 bg-green-50">
                  ...
                  <p className="text-sm text-green-700 mb-2">
                    3 containers scheduled for maintenance next week. Proactive
                    scheduling prevents 85% of unexpected breakdowns.
                  </p>
                ...
                <div className="border rounded-lg p-4 bg-purple-50">
                  ...
                  <p className="text-sm text-purple-700 mb-2">
                    Automated regulatory compliance checking detected and
                    prevented 12 potential violations this month.
                  </p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="border-t pt-4">
                  <p className="text-sm text-gray-600">
                    Your organization ranks in the <strong>top 10%</strong> of
                    dangerous goods transport companies globally, with
                    exceptional performance in AI-driven safety management and
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-medium">
                      Expand Smart Container Fleet
                    </span>
                  </div>
                  <p className="text-sm text-gray-600 mb-2">
                    Increasing IoT-enabled containers by 25% could improve
                    monitoring coverage to 95% and reduce temperature excursion
                    incidents by an estimated 40%.
                  </p>
                  <div className="flex items-center justify-between text-xs">
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    Implementing machine learning-based dynamic routing could
                    optimize delivery schedules and reduce fuel consumption by
                    12-15%.
                  </p>
                  <div className="flex items-center justify-between text-xs">
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    Full automation of compliance checking across all transport
                    modes could eliminate manual errors and reduce compliance
                    staff workload by 60%.
                  </p>
                  <div className="flex items-center justify-between text-xs">
