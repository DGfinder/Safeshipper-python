    ...
    <div className="space-y-4">
      <div className="text-center">
        ...
        <p className="text-gray-600 text-sm">
          Choose a two-factor authentication method to add extra security to your account.
        </p>
      </div>
    ...
    <div className="text-center space-y-4">
      ...
      <div>
        ...
        <p className="text-gray-600">
          Your two-factor authentication is now active and your account is more secure.
        </p>
      </div>
    </div>
  );
