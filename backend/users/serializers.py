...
class UserUpdateSerializer(serializers.ModelSerializer):
    # Used by users to update their own profile or by admins to update others
    # Password change should be handled by a separate endpoint/serializer for security
    class Meta:
        model = User
        fields = [
            'email', 
            'first_name', 
            'last_name', 
            # Admin-only updatable fields (controlled by view/permissions)
            'role', 
            'depot', 
            'area',
            'is_active',
